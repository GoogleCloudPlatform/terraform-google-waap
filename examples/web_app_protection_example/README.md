...
|------|-------------|------|---------|:--------:|
| backend\_port | Port used by the backend | `number` | `80` | no |
...
| enable\_cdn | Enable or disable the CDN feature | `bool` | `true` | no |
...
| region\_r1 | Region one in which to create resources. | `string` | `"us-central1"` | no |
| region\_r2 | Region two in which to create resources. | `string` | `"us-east1"` | no |
...
| subnet\_ip\_r1 | Subnet IP. | `string` | `"10.0.16.0/24"` | no |
| subnet\_ip\_r2 | Subnet IP. | `string` | `"10.0.32.0/24"` | no |
...
| tags\_r1 | Network tags, provided as a list | `list(string)` | <pre>[<br>  "backend-r1",<br>  "lb-web-hc"<br>]</pre> | no |
| tags\_r2 | Network tags, provided as a list | `list(string)` | <pre>[<br>  "backend-r2",<br>  "lb-web-hc"<br>]</pre> | no |
...
| zone\_r1 | Zone one in which to create resources. | `string` | `"us-central1-b"` | no |
| zone\_r2 | Zone two in which to create resources. | `string` | `"us-east1-b"` | no |
